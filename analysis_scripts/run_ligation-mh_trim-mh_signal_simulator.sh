...
Rscript $PWD/mechanistic-trimming/analysis_scripts/ligation-mh_signal_simulator/process_data_for_ligation-mh_trim_signal_simulation.R $PARAM_GROUP $NCPU $TRIM_SAMPLING_TYPE $LIGATION_MH_PARAM $INT_MH_PARAM $NP_COND
