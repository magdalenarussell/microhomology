...
model_types = list('motif_two-side-base-count-beyond_average-interior-mh-count' = c(1,2), 'motif_two-side-base-count-beyond' = c(1, 2), 'null' = c(0,0))
...
new_model_types = list('motif_two-side-base-count-beyond_average-interior-mh-count' = '1x2motif + two-side base-count beyond +\naverage trim MH\n(25 params)', 'motif_two-side-base-count-beyond' = '1x2motif + two-side base-count-beyond\n(24 params)', 'null' = 'null (0 params)')
...
fwrite(loss_data, paste0(PROJECT_PATH, '/plotting_scripts/manuscript_figs/validation_loss/trimMH_model/loss.tsv'), sep = '\t')
