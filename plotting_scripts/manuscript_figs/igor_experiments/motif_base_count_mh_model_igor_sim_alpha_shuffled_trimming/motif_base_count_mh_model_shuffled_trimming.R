...
fwrite(coefs, paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/igor_experiments/motif_base_count_mh_model_igor_sim_experiment/coefs.tsv'), sep = '\t')
...
j_motif_heatmap = plot_motif_coefficient_heatmap_single_group(coefs[trim_type == 'j_trim'], with_values = FALSE, limits = c(-0.246, 0.246)) + ggtitle('   J-trimming coefficients')
...
v_base_count_heatmap = plot_base_count_coefficient_heatmap_single_group(coefs[trim_type == 'v_trim'], with_values = FALSE, limits = c(-0.246, 0.246))
j_base_count_heatmap = plot_base_count_coefficient_heatmap_single_group(coefs[trim_type == 'j_trim'], with_values = FALSE, limits = c(-0.246, 0.246))
...
# plot mh heatmap
mh_heatmap = plot_mh_coefficient_heatmap_single_group(coefs, with_values = FALSE, limits = c(-0.246, 0.246))
...
# save plot
file_name = paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/igor_experiments/motif_base_count_mh_model_igor_sim_alpha_shuffled_trimming/coef_heatmap_shuffled_trimming.pdf')
