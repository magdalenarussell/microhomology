...
fwrite(coefs, paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/igor_experiments/motif_base_count_ligation-mh_igor_sim_alpha_independent_vj/coefs.tsv'), sep = '\t')
...
# save plot
file_name = paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/igor_experiments/motif_base_count_ligation-mh_igor_sim_alpha_independent_vj/coef_heatmap.pdf')
