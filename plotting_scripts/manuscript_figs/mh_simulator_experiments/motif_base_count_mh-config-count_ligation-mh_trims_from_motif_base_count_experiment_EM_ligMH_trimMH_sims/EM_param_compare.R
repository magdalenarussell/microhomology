...
# save plot
file_name = paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/mh_simulator_experiments/motif_base_count_mh-config-count_ligation-mh_trims_from_motif_base_count_experiment_EM_ligMH_trimMH_sims/compare_lig.pdf')
...
# save plot
file_name = paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/mh_simulator_experiments/motif_base_count_mh-config-count_ligation-mh_trims_from_motif_base_count_experiment_EM_ligMH_trimMH_sims/compare_int.pdf')
