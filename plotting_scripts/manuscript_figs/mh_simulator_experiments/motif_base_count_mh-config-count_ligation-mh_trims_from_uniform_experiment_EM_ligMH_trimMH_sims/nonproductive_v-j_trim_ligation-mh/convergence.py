...
ANNOTATION_TYPE_ROOT = 'igor_mh_sim_alpha_from_uniform_MHprob'
...
file_name = MOD_PROJECT_PATH + '/plotting_scripts/manuscript_figs/mh_simulator_experiments/motif_base_count_mh-config-count_ligation-mh_trims_from_uniform_experiment_EM_ligMH_trimMH_sims/' +  PARAM_GROUP + '/convergence.pdf'
