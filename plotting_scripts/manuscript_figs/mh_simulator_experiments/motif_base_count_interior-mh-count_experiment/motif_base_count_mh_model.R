...
for (param in INT_MH_PARAMS){
    ...
    ANNOTATION_TYPE <<- paste0(old_annotation, '_from_uniform_MHprob', param)
    ...
    assign(paste0('together', param), plot_grid(first_grid, NULL, second_grid, NULL, third_grid, NULL, legend, nrow = 7, rel_heights = c(1, 0.08, 1, 0.08, 1.5, 0.08, 0.2)))
}

together = plot_grid(together0, NULL, together1, NULL, ncol = 4, rel_widths = c(1, 0.10, 1, 0.10))
...
ggsave(file_name, plot = together, width = 36, height = 21.5, units = 'in', dpi = 750, device = cairo_pdf, limitsize=FALSE)
