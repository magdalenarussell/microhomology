...
# save plot
file_name = paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/mh_simulator_experiments/compare_EM_noEM_simulator_simple/compare_lig_uniform.pdf')
...
# save plot
file_name = paste0(MOD_PROJECT_PATH, '/plotting_scripts/manuscript_figs/mh_simulator_experiments/compare_EM_noEM_simulator_simple/compare_trim_uniform.pdf')
