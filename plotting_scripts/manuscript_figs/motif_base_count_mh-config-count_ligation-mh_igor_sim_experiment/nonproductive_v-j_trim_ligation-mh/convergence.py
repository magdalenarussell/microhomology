...
file_name = MOD_PROJECT_PATH + '/plotting_scripts/manuscript_figs/motif_base_count_mh-config-count_ligation-mh_igor_sim_experiment/' +  PARAM_GROUP + '/convergence.pdf'
